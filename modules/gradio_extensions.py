...
original_IOComponent_init = patch(__name__, obj=gr.components.Component, field="__init__", replacement=IOComponent_init)
...
gradio_component_meta_create_or_modify_pyi_original = patch(__file__, gradio.component_meta, 'create_or_modify_pyi', gradio_component_meta_create_or_modify_pyi)
